...
def generate_sarif_report(analysis_result: Dict, source_code: str = "") -> Dict:
    """
    ...
    Includes a scanManifest property with SHA-256 of source, tool version,
    and analysis timestamp for tamper-evident audit trails (SV-2-1).
    """
    import hashlib
        ...
        results.append({
            "ruleId": vuln.get("type", "unknown"),
                ...
                "properties": {
                    ...
                    "swcId": vuln.get("swc_id", "N/A"),
                    "swcTitle": vuln.get("swc_title", "N/A"),
                    "cwe": vuln.get("cwe", "N/A"),
                }
            })
    
# Build scan manifest for tamper-evident audit trail (SV-2-1).
    analysis_ts = datetime.now(timezone.utc).isoformat()
    source_hash = hashlib.sha256(source_code.encode("utf-8", errors="replace")).hexdigest() if source_code else None
    scan_manifest = {
        "schemaVersion": "sarif/v1",
        "toolName": "Solidity Vuln Scanner",
        "toolVersion": "1.0.0",
    ...
    sarif = {
        ...
        "runs": [{
            ...
            "properties": {
                ...
                "analysisDate": analysis_ts,
                "scanManifest": scan_manifest,
            }
        }]
    }
