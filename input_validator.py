...
def validate_webhook_url(webhook_url: str, allow_private_networks: bool = False) -> Tuple[bool, Optional[str]]:
    """Validate webhook URL and block SSRF-prone destinations by default."""
    ...
    try:
        resolved_addresses = {item[4][0] for item in socket.getaddrinfo(hostname, parsed.port, type=socket.SOCK_STREAM)}
    ...
    for address in resolved_addresses:
        ...
        if (
            ...
            return False, "Webhook URL cannot target private or non-routable addresses"
